...
export default function Keyboard({ onKeyPress, usedLetters }: Props): JSX.Element {
    const handleKeyDown = useCallback((event: KeyboardEvent) => onKeyPress(event.key), [onKeyPress]);
    ...
    return (
        <div className="game-keyboard">
            ...
            <div className="game-keyboard-row">
                ...
                <button type="button" data-key="←" className="game-keyboard-key longer" onClick={()=>onKeyPress('Backspace')} data-testid="backspace-key">
